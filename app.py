...
def init_db():
    conn = sqlite3.connect('uiu_bot.db')
    c = conn.cursor()
...
async def help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    help_text = (
        ...
        "9. **/mentor find <department|expertise>** - Find UIU faculty mentors from all departments (CSE, BBA, Pharmacy, Economics, etc.).\n"
...
async def calendar(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.error(f"Scraping calendar failed: {e}")
        temp_calendar.clear()
...
async def resources(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.error(f"Scraping resources failed: {e}")
...
async def trending(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.error(f"Scraping trending repos failed: {e}")
        temp_trending.clear()
...
async def stackoverflow(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.error(f"Scraping Stack Overflow failed: {e}")
        temp_stackoverflow.clear()
...
async def roadmap(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if not roadmaps or time.time() - c.execute("SELECT last_updated FROM roadmaps WHERE roadmap_type = ? LIMIT 1", (roadmap_type,)).fetchone()[0] > 24*3600:
            try:
                process = CrawlerProcess({'USER_AGENT': 'Mozilla/5.0'})
        ...
        logger.error(f"Database error for roadmap: {e}")
        roadmaps = []
...
async def mentor(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.error(f"Scraping faculty failed: {e}")
        temp_faculty.clear()
...
async def notice(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.error(f"Scraping notices failed: {e}")
        temp_notices.clear()
...
async def studyplan(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("Usage: /studyplan cse321,cse322 10 2025-12-01 cse321:1,cse322:2\nSee /help for details.")
...
async def reminders(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("Error setting/listing reminders. Try again or see /help for details.")
    finally:
        conn.close()
...
async def motivate(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        await update.message.reply_text("Error fetching motivational tip. Try again later.")
...
async def codeshare(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.error(f"Error in codeshare: {e}")
        await update.message.reply_text("Error handling code snippets. Try again or see /help for details.")
    finally:
        conn.close()
...
async def profile(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("Error setting profile. Try again or see /help for details.")
...
async def progress(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("Error fetching progress. Try again or see /help for details.")
...
async def recommend(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("Error fetching recommendations. Try again or see /help for details.")
